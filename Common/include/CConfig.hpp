...
private:
  ...
  *Supercatalytic_Wall_Composition,         /*!< \brief Supercatalytic wall mass fractions [dimensionless]. */
  ...
  SU2_NONEQ_CustomChemistry,                /*!< \brief Enable custom SU2_NONEQ chemistry tables. */
  monoatomic,                               /*!< \brief Flag for monoatomic mixture. */
  Supercatalytic_Wall;                      /*!< \brief Flag for supercatalytic wall. */
  string GasModel,                          /*!< \brief Gas Model. */
  Chemistry_File,                          /*!< \brief Cantera YAML mechanism file for the detonation solver. */
  Chemistry_Splitting,                     /*!< \brief Chemistry-flow operator splitting mode for DETONATION_EULER. */
  SU2_NONEQ_SpeciesTable_File,              /*!< \brief Species data table for custom SU2_NONEQ chemistry. */
  SU2_NONEQ_ElectronicStates_File,          /*!< \brief Electronic-states table for custom SU2_NONEQ chemistry. */
  SU2_NONEQ_Reactions_File,                 /*!< \brief Reactions table for custom SU2_NONEQ chemistry. */
  SU2_NONEQ_Transport_File,                 /*!< \brief Transport table for custom SU2_NONEQ chemistry. */
  SU2_NONEQ_KeqCoeff_File,                  /*!< \brief Equilibrium-coefficients table for custom SU2_NONEQ chemistry. */
  *Wall_Catalytic;                          /*!< \brief Pointer to catalytic walls. */
  TRANSCOEFFMODEL   Kind_TransCoeffModel;   /*!< \brief Transport coefficient Model for NEMO solver. */
  NEMO_TEMPERATURE_MODEL Kind_NEMOTemperatureModel; /*!< \brief Temperature closure for NEMO solver. */
  su2double CatalyticEfficiency;            /*!< \brief Wall catalytic efficiency. */
  su2double Chemistry_T_RTL,                /*!< \brief Relative tolerance for temperature in chemistry integration. */
  Chemistry_T_ATL,                          /*!< \brief Absolute tolerance for temperature in chemistry integration. */
  Chemistry_Y_RTL,                          /*!< \brief Relative tolerance for species in chemistry integration. */
  Chemistry_Y_ATL,                          /*!< \brief Absolute tolerance for species in chemistry integration. */
  Chemistry_Clip_TMin,                      /*!< \brief Minimum temperature clip for chemistry integration. */
  Chemistry_Clip_TMax,                      /*!< \brief Maximum temperature clip for chemistry integration. */
  Chemistry_Clip_YMin;                      /*!< \brief Minimum species mass fraction clip for chemistry integration. */
  unsigned long Chemistry_Max_Substeps;     /*!< \brief Maximum number of chemistry retry substeps. */
  bool Detonation_Debug_Residual_Breakdown, /*!< \brief Enable residual-stage debug output for DETONATION_EULER verification. */
  Detonation_Debug_BC_Residual,             /*!< \brief Enable per-marker boundary residual CSV debug output for DETONATION_EULER verification. */
  Detonation_Chem_Energy_Audit,             /*!< \brief Enable chemistry-energy audit CSV output for DETONATION_EULER verification. */
  Detonation_Chemistry_Only,                /*!< \brief Skip flow residual/update and advance chemistry only for 0D verification. */
  Detonation_LeftRight_Init;                /*!< \brief Enable verification-only left/right primitive initialization for DETONATION_EULER. */
  string Detonation_Chem_Energy_Audit_File; /*!< \brief Base CSV path for chemistry-energy audit output. */
  su2double Detonation_Init_Discontinuity_X,/*!< \brief x-location of the verification-only left/right discontinuity. */
  Detonation_Init_Left_Pressure,            /*!< \brief Left pressure for verification-only left/right initialization. */
  Detonation_Init_Right_Pressure,           /*!< \brief Right pressure for verification-only left/right initialization. */
  Detonation_Init_Left_Temperature,         /*!< \brief Left temperature for verification-only left/right initialization. */
  Detonation_Init_Right_Temperature,        /*!< \brief Right temperature for verification-only left/right initialization. */
  Detonation_Init_Left_U,                   /*!< \brief Left x-velocity for verification-only left/right initialization. */
  Detonation_Init_Left_V,                   /*!< \brief Left y-velocity for verification-only left/right initialization. */
  Detonation_Init_Left_W,                   /*!< \brief Left z-velocity for verification-only left/right initialization. */
  Detonation_Init_Right_U,                  /*!< \brief Right x-velocity for verification-only left/right initialization. */
  Detonation_Init_Right_V,                  /*!< \brief Right y-velocity for verification-only left/right initialization. */
  Detonation_Init_Right_W;                  /*!< \brief Right z-velocity for verification-only left/right initialization. */
...
/*!
  ...
  /*!
   * \brief Get the detonation chemistry mechanism file.
   */
  string GetChemistry_File(void) const { return Chemistry_File; }

  /*!
   * \brief Get the chemistry-flow splitting mode for DETONATION_EULER.
   */
  string GetChemistry_Splitting(void) const { return Chemistry_Splitting; }
  ...
  /*!\
   * \brief Get the NEMO temperature closure model.
   * \return NEMO temperature closure model.
   */
  NEMO_TEMPERATURE_MODEL GetKind_NEMOTemperatureModel(void) const { return Kind_NEMOTemperatureModel; }

  /*!\
   * \brief Indicates whether custom SU2_NONEQ chemistry tables are enabled.
   */
  bool GetSU2_NONEQ_CustomChemistry(void) const { return SU2_NONEQ_CustomChemistry; }

  /*!\
   * \brief Get custom SU2_NONEQ chemistry species table file.
   */
  string GetSU2_NONEQ_SpeciesTable_File(void) const { return SU2_NONEQ_SpeciesTable_File; }

  /*!\
   * \brief Get custom SU2_NONEQ chemistry electronic-states table file.
   */
  string GetSU2_NONEQ_ElectronicStates_File(void) const { return SU2_NONEQ_ElectronicStates_File; }

  /*!\
   * \brief Get custom SU2_NONEQ chemistry reactions table file.
   */
  string GetSU2_NONEQ_Reactions_File(void) const { return SU2_NONEQ_Reactions_File; }

  /*!\
   * \brief Get custom SU2_NONEQ chemistry transport table file.
   */
  string GetSU2_NONEQ_Transport_File(void) const { return SU2_NONEQ_Transport_File; }

  /*!\
   * \brief Get custom SU2_NONEQ chemistry Keq-coefficients table file.
   */
  string GetSU2_NONEQ_KeqCoeff_File(void) const { return SU2_NONEQ_KeqCoeff_File; }

  /*!
   * \brief Get temperature relative tolerance for chemistry integration.
   */
  su2double GetChemistry_T_RTL(void) const { return Chemistry_T_RTL; }

  /*!
   * \brief Get temperature absolute tolerance for chemistry integration.
   */
  su2double GetChemistry_T_ATL(void) const { return Chemistry_T_ATL; }

  /*!
   * \brief Get species relative tolerance for chemistry integration.
   */
  su2double GetChemistry_Y_RTL(void) const { return Chemistry_Y_RTL; }

  /*!
   * \brief Get species absolute tolerance for chemistry integration.
   */
  su2double GetChemistry_Y_ATL(void) const { return Chemistry_Y_ATL; }

  /*!
   * \brief Get maximum chemistry retry substeps.
   */
  unsigned long GetChemistry_Max_Substeps(void) const { return Chemistry_Max_Substeps; }

  /*!
   * \brief Get minimum chemistry temperature clip.
   */
  su2double GetChemistry_Clip_TMin(void) const { return Chemistry_Clip_TMin; }

  /*!
   * \brief Get maximum chemistry temperature clip.
   */
  su2double GetChemistry_Clip_TMax(void) const { return Chemistry_Clip_TMax; }

  /*!
   * \brief Get minimum chemistry species clip.
   */
  su2double GetChemistry_Clip_YMin(void) const { return Chemistry_Clip_YMin; }

  /*!
   * \brief Indicates whether residual-stage debug output is enabled for DETONATION_EULER.
   */
  bool GetDetonation_Debug_Residual_Breakdown(void) const { return Detonation_Debug_Residual_Breakdown; }

  /*!
   * \brief Indicates whether per-marker boundary residual CSV debug output is enabled for DETONATION_EULER.
   */
  bool GetDetonation_Debug_BC_Residual(void) const { return Detonation_Debug_BC_Residual; }

  /*!
   * \brief Indicates whether chemistry-energy audit CSV output is enabled for DETONATION_EULER.
   */
  bool GetDetonation_Chem_Energy_Audit(void) const { return Detonation_Chem_Energy_Audit; }

  /*!
   * \brief Indicates whether DETONATION_EULER should skip flow updates and run chemistry only.
   */
  bool GetDetonation_Chemistry_Only(void) const { return Detonation_Chemistry_Only; }

  /*!
   * \brief Indicates whether DETONATION_EULER should initialize a verification-only left/right primitive patch.
   */
  bool GetDetonation_LeftRight_Init(void) const { return Detonation_LeftRight_Init; }

  /*!
   * \brief Base CSV path for chemistry-energy audit output.
   */
  string GetDetonation_Chem_Energy_Audit_File(void) const { return Detonation_Chem_Energy_Audit_File; }

  /*!
   * \brief Get x-location of the verification-only left/right discontinuity.
   */
  su2double GetDetonation_Init_Discontinuity_X(void) const { return Detonation_Init_Discontinuity_X; }

  /*!
   * \brief Get left pressure for verification-only left/right initialization.
   */
  su2double GetDetonation_Init_Left_Pressure(void) const { return Detonation_Init_Left_Pressure; }

  /*!
   * \brief Get right pressure for verification-only left/right initialization.
   */
  su2double GetDetonation_Init_Right_Pressure(void) const { return Detonation_Init_Right_Pressure; }

  /*!
   * \brief Get left temperature for verification-only left/right initialization.
   */
  su2double GetDetonation_Init_Left_Temperature(void) const { return Detonation_Init_Left_Temperature; }

  /*!
   * \brief Get right temperature for verification-only left/right initialization.
   */
  su2double GetDetonation_Init_Right_Temperature(void) const { return Detonation_Init_Right_Temperature; }

  /*!
   * \brief Get left x-velocity for verification-only left/right initialization.
   */
  su2double GetDetonation_Init_Left_U(void) const { return Detonation_Init_Left_U; }

  /*!
   * \brief Get left y-velocity for verification-only left/right initialization.
   */
  su2double GetDetonation_Init_Left_V(void) const { return Detonation_Init_Left_V; }

  /*!
   * \brief Get left z-velocity for verification-only left/right initialization.
   */
  su2double GetDetonation_Init_Left_W(void) const { return Detonation_Init_Left_W; }

  /*!
   * \brief Get right x-velocity for verification-only left/right initialization.
   */
  su2double GetDetonation_Init_Right_U(void) const { return Detonation_Init_Right_U; }

  /*!
   * \brief Get right y-velocity for verification-only left/right initialization.
   */
  su2double GetDetonation_Init_Right_V(void) const { return Detonation_Init_Right_V; }

  /*!
   * \brief Get right z-velocity for verification-only left/right initialization.
   */
  su2double GetDetonation_Init_Right_W(void) const { return Detonation_Init_Right_W; }
