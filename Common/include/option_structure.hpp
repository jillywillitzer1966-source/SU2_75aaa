...
enum class MAIN_SOLVER {
  ...
  MULTIPHYSICS,
  DETONATION_EULER,            /*!< \brief Definition of the detonation Euler solver. */
...
static const MapType<std::string, MAIN_SOLVER> Solver_Map = {
  ...
  MakePair("DETONATION_EULER", MAIN_SOLVER::DETONATION_EULER)
...
enum ENUM_FLUIDMODEL {
  ...
  CANTERA_REACTIVE = 13,  /*!< \brief Cantera-backed reactive-gas model for detonation flows. */
};
static const MapType<std::string, ENUM_FLUIDMODEL> FluidModel_Map = {
  ...
  MakePair("CANTERA_REACTIVE", CANTERA_REACTIVE)
};

/*!\
 * \brief Temperature closure for NEMO models.
 */
enum class NEMO_TEMPERATURE_MODEL {
  DUAL_TEMPERATURE,
  SINGLE_TEMPERATURE,
};
static const MapType<std::string, NEMO_TEMPERATURE_MODEL> NEMOTemperatureModel_Map = {
  MakePair("DUAL_TEMPERATURE", NEMO_TEMPERATURE_MODEL::DUAL_TEMPERATURE)
  MakePair("SINGLE_TEMPERATURE", NEMO_TEMPERATURE_MODEL::SINGLE_TEMPERATURE)
};
...
enum class UPWIND {
  ...
  DETONATION_LLF,         /*!< \brief Detonation Phase-1 LLF/Rusanov-like placeholder. */
  DETONATION_HLLC,        /*!< \brief Detonation Euler HLLC candidate flux. */
...
static const MapType<std::string, UPWIND> Upwind_Map = {
  ...
  MakePair("DETONATION_LLF", UPWIND::DETONATION_LLF)
  MakePair("DETONATION_HLLC", UPWIND::DETONATION_HLLC)
...
enum ENUM_TIME_INT {
  ...
  POINT_IMPLICIT = 6          /*!< \brief Point-implicit local block solve definition. */
};
static const MapType<std::string, ENUM_TIME_INT> Time_Int_Map = {
  ...
  MakePair("POINT_IMPLICIT", POINT_IMPLICIT)
};
