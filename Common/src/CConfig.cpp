...
void CConfig::SetConfig_Options() {
  ...
  /*!\brief NEMO_TEMPERATURE_MODEL \n DESCRIPTION: Temperature closure for NEMO models \n OPTIONS: See \link NEMOTemperatureModel_Map \endlink \n DEFAULT: DUAL_TEMPERATURE \ingroup Config*/
  addEnumOption("NEMO_TEMPERATURE_MODEL", Kind_NEMOTemperatureModel, NEMOTemperatureModel_Map, NEMO_TEMPERATURE_MODEL::DUAL_TEMPERATURE);
  ...
  /* DESCRIPTION: Cantera YAML mechanism file used by the detonation solver */
  addStringOption("CHEMISTRY_FILE", Chemistry_File, string("NONE"));
  /* DESCRIPTION: Operator splitting mode used by the detonation solver */
  addStringOption("CHEMISTRY_SPLITTING", Chemistry_Splitting, string("LIE"));
  /* DESCRIPTION: Relative tolerance for chemistry temperature integration */
  addDoubleOption("CHEMISTRY_T_RTL", Chemistry_T_RTL, 1.0e-8);
  /* DESCRIPTION: Absolute tolerance for chemistry temperature integration */
  addDoubleOption("CHEMISTRY_T_ATL", Chemistry_T_ATL, 1.0e-10);
  /* DESCRIPTION: Relative tolerance for chemistry species integration */
  addDoubleOption("CHEMISTRY_Y_RTL", Chemistry_Y_RTL, 1.0e-8);
  /* DESCRIPTION: Absolute tolerance for chemistry species integration */
  addDoubleOption("CHEMISTRY_Y_ATL", Chemistry_Y_ATL, 1.0e-15);
  /* DESCRIPTION: Maximum number of chemistry retry substeps */
  addUnsignedLongOption("CHEMISTRY_MAX_SUBSTEPS", Chemistry_Max_Substeps, 8);
  /* DESCRIPTION: Minimum chemistry temperature clip */
  addDoubleOption("CHEMISTRY_CLIP_TMIN", Chemistry_Clip_TMin, 200.0);
  /* DESCRIPTION: Maximum chemistry temperature clip */
  addDoubleOption("CHEMISTRY_CLIP_TMAX", Chemistry_Clip_TMax, 20000.0);
  /* DESCRIPTION: Minimum chemistry mass fraction clip */
  addDoubleOption("CHEMISTRY_CLIP_YMIN", Chemistry_Clip_YMin, 1.0e-30);
  /* DESCRIPTION: Emit residual-stage debug output for DETONATION_EULER verification */
  addBoolOption("DETONATION_DEBUG_RESIDUAL_BREAKDOWN", Detonation_Debug_Residual_Breakdown, false);
  /* DESCRIPTION: Emit per-marker boundary residual CSV debug output for DETONATION_EULER verification */
  addBoolOption("DETONATION_DEBUG_BC_RESIDUAL", Detonation_Debug_BC_Residual, false);
  /* DESCRIPTION: Emit chemistry-energy audit CSV files for DETONATION_EULER verification */
  addBoolOption("DETONATION_CHEM_ENERGY_AUDIT", Detonation_Chem_Energy_Audit, false);
  /* DESCRIPTION: Skip all flow residual/update work and advance chemistry only (0D verification tool) */
  addBoolOption("DETONATION_CHEMISTRY_ONLY", Detonation_Chemistry_Only, false);
  /* DESCRIPTION: Enable verification-only left/right primitive initialization for DETONATION_EULER */
  addBoolOption("DETONATION_LEFT_RIGHT_INIT", Detonation_LeftRight_Init, false);
  /* DESCRIPTION: Base CSV path for DETONATION_EULER chemistry-energy audit output */
  addStringOption("DETONATION_CHEM_ENERGY_AUDIT_FILE", Detonation_Chem_Energy_Audit_File,
                  string("chem_energy_worst_cells.csv"));
  /* DESCRIPTION: x-location of the verification-only left/right discontinuity */
  addDoubleOption("DETONATION_INIT_DISCONTINUITY_X", Detonation_Init_Discontinuity_X, 0.5);
  /* DESCRIPTION: Left pressure for verification-only left/right initialization */
  addDoubleOption("DETONATION_INIT_LEFT_PRESSURE", Detonation_Init_Left_Pressure, 101325.0);
  /* DESCRIPTION: Right pressure for verification-only left/right initialization */
  addDoubleOption("DETONATION_INIT_RIGHT_PRESSURE", Detonation_Init_Right_Pressure, 101325.0);
  /* DESCRIPTION: Left temperature for verification-only left/right initialization */
  addDoubleOption("DETONATION_INIT_LEFT_TEMPERATURE", Detonation_Init_Left_Temperature, 300.0);
  /* DESCRIPTION: Right temperature for verification-only left/right initialization */
  addDoubleOption("DETONATION_INIT_RIGHT_TEMPERATURE", Detonation_Init_Right_Temperature, 300.0);
  /* DESCRIPTION: Left x-velocity for verification-only left/right initialization */
  addDoubleOption("DETONATION_INIT_LEFT_U", Detonation_Init_Left_U, 0.0);
  /* DESCRIPTION: Left y-velocity for verification-only left/right initialization */
  addDoubleOption("DETONATION_INIT_LEFT_V", Detonation_Init_Left_V, 0.0);
  /* DESCRIPTION: Left z-velocity for verification-only left/right initialization */
  addDoubleOption("DETONATION_INIT_LEFT_W", Detonation_Init_Left_W, 0.0);
  /* DESCRIPTION: Right x-velocity for verification-only left/right initialization */
  addDoubleOption("DETONATION_INIT_RIGHT_U", Detonation_Init_Right_U, 0.0);
  /* DESCRIPTION: Right y-velocity for verification-only left/right initialization */
  addDoubleOption("DETONATION_INIT_RIGHT_V", Detonation_Init_Right_V, 0.0);
  /* DESCRIPTION: Right z-velocity for verification-only left/right initialization */
  addDoubleOption("DETONATION_INIT_RIGHT_W", Detonation_Init_Right_W, 0.0);
  /* DESCRIPTION: Enable external custom chemistry tables for SU2_NONEQ without changing built-in gas-model logic */
  addBoolOption("SU2_NONEQ_CUSTOM_CHEMISTRY", SU2_NONEQ_CustomChemistry, false);
  /* DESCRIPTION: Species table file for custom SU2_NONEQ chemistry */
  addStringOption("SU2_NONEQ_SPECIES_TABLE", SU2_NONEQ_SpeciesTable_File, string("NONE"));
  /* DESCRIPTION: Electronic-states table file for custom SU2_NONEQ chemistry */
  addStringOption("SU2_NONEQ_ELECTRONIC_STATES_TABLE", SU2_NONEQ_ElectronicStates_File, string("NONE"));
  /* DESCRIPTION: Reactions table file for custom SU2_NONEQ chemistry */
  addStringOption("SU2_NONEQ_REACTIONS_TABLE", SU2_NONEQ_Reactions_File, string("NONE"));
  /* DESCRIPTION: Transport table file for custom SU2_NONEQ chemistry */
  addStringOption("SU2_NONEQ_TRANSPORT_TABLE", SU2_NONEQ_Transport_File, string("NONE"));
  /* DESCRIPTION: Equilibrium-coefficient table file for custom SU2_NONEQ chemistry */
  addStringOption("SU2_NONEQ_KEQ_TABLE", SU2_NONEQ_KeqCoeff_File, string("NONE"));
...
void CConfig::SetPostprocessing(SU2_COMPONENT val_software, unsigned short val_izone, unsigned short val_nDim) {
  ...
  bool reactive_gas = (Kind_FluidModel == CANTERA_REACTIVE);
  ...
  switch (Kind_Solver) {
    ...
    case MAIN_SOLVER::DETONATION_EULER:
  ...
  if (Kind_Solver == MAIN_SOLVER::DETONATION_EULER) {
    string splittingMode = Chemistry_Splitting;
    std::transform(splittingMode.begin(), splittingMode.end(), splittingMode.begin(),
                   [](unsigned char c) { return static_cast<char>(std::toupper(c)); });
    Chemistry_Splitting = splittingMode;

    if (!reactive_gas) {
      SU2_MPI::Error("DETONATION_EULER currently requires FLUID_MODEL= CANTERA_REACTIVE.", CURRENT_FUNCTION);
    }
    if (Chemistry_File == "NONE") {
      SU2_MPI::Error("DETONATION_EULER requires CHEMISTRY_FILE to point to a Cantera YAML mechanism.", CURRENT_FUNCTION);
    }
    if (TimeMarching != TIME_MARCHING::TIME_STEPPING) {
      SU2_MPI::Error("DETONATION_EULER Phase-1 only supports TIME_MARCHING= TIME_STEPPING.", CURRENT_FUNCTION);
    }
    if (Kind_TimeIntScheme_Flow != EULER_EXPLICIT) {
      SU2_MPI::Error("DETONATION_EULER Phase-1 only supports TIME_INT_SCHEME_FLOW= EULER_EXPLICIT.", CURRENT_FUNCTION);
    }
    if (GetDynamic_Grid()) {
      SU2_MPI::Error("DETONATION_EULER Phase-1 only supports static grids.", CURRENT_FUNCTION);
    }
    if (nZone > 1) {
      SU2_MPI::Error("DETONATION_EULER Phase-1 only supports single-zone problems.", CURRENT_FUNCTION);
    }
    if (Kind_ConvNumScheme_Flow != SPACE_UPWIND ||
        (Kind_Upwind_Flow != UPWIND::DETONATION_LLF && Kind_Upwind_Flow != UPWIND::DETONATION_HLLC)) {
      SU2_MPI::Error("DETONATION_EULER Phase-1 requires SPACE_UPWIND with CONV_NUM_METHOD_FLOW= DETONATION_LLF or DETONATION_HLLC.", CURRENT_FUNCTION);
    }
    if (Chemistry_Splitting != "LIE" && Chemistry_Splitting != "STRANG") {
      SU2_MPI::Error("DETONATION_EULER only supports CHEMISTRY_SPLITTING= LIE or STRANG.", CURRENT_FUNCTION);
    }
    if (nSpecies == 0) {
      SU2_MPI::Error("DETONATION_EULER requires a positive number of species entries in GAS_COMPOSITION.", CURRENT_FUNCTION);
    }
    if (Detonation_Chemistry_Only && frozen) {
      SU2_MPI::Error("DETONATION_CHEMISTRY_ONLY= YES cannot be combined with FROZEN_MIXTURE= YES.", CURRENT_FUNCTION);
    }
  }
  ...
  if (Kind_Solver == MAIN_SOLVER::EULER ||
      ...
      Kind_Solver == MAIN_SOLVER::DETONATION_EULER ||
...
/*--- Set default values for various fluid properties. ---*/
  ...
  /*--- Check whether inputs for FLUID_MIXTURE are correctly specified. ---*/
    ...
    if (Kind_FluidModel == SU2_NONEQ && SU2_NONEQ_CustomChemistry) {
      if (GasModel != "CUSTOM") {
        SU2_MPI::Error("For SU2_NONEQ_CUSTOM_CHEMISTRY=YES, set GAS_MODEL=CUSTOM to avoid changing built-in gas-model logic.", CURRENT_FUNCTION);
      }
      if (ionization) {
        SU2_MPI::Error("For SU2_NONEQ_CUSTOM_CHEMISTRY=YES, IONIZATION must be NO for the current non-ionized chemistry setup.", CURRENT_FUNCTION);
      }
      if (nWall_Catalytic != 0 || Supercatalytic_Wall) {
        SU2_MPI::Error("For SU2_NONEQ_CUSTOM_CHEMISTRY=YES, catalytic-wall options are disabled in the current setup.", CURRENT_FUNCTION);
      }
      if (SU2_NONEQ_SpeciesTable_File == "NONE" || SU2_NONEQ_ElectronicStates_File == "NONE" ||
          SU2_NONEQ_Reactions_File == "NONE" || SU2_NONEQ_Transport_File == "NONE" ||
          SU2_NONEQ_KeqCoeff_File == "NONE") {
        SU2_MPI::Error("For SU2_NONEQ_CUSTOM_CHEMISTRY=YES, all custom table files must be specified.", CURRENT_FUNCTION);
      }
    }
    ...
    if (!ideal_gas && !nemo && Kind_Solver != MAIN_SOLVER::DETONATION_EULER) {
  ...
  if (Compute_Metric) {
    ...
    for (auto iSensor = 0; iSensor < nAdap_Sensor; iSensor++) {
      if (find(begin(Sensor_Avail), end(Sensor_Avail), Adap_Sensor[iSensor]) != end(Sensor_Avail)) {
        ...
        if (Kind_Solver == MAIN_SOLVER::NEMO_EULER || Kind_Solver == MAIN_SOLVER::NEMO_NAVIER_STOKES || Kind_Solver == MAIN_SOLVER::NEMO_RANS) {
    ...
    switch (Kind_Solver) {
      ...
      case MAIN_SOLVER::NEMO_EULER:
        if (Kind_Regime == ENUM_REGIME::COMPRESSIBLE) {
          if (Kind_NEMOTemperatureModel == NEMO_TEMPERATURE_MODEL::SINGLE_TEMPERATURE) cout << "Compressible single-temperature thermochemical non-equilibrium Euler equations." << endl;
          else cout << "Compressible two-temperature thermochemical non-equilibrium Euler equations." << endl;
        }
        if (Kind_FluidModel == SU2_NONEQ){
          if (!SU2_NONEQ_CustomChemistry && (GasModel != "N2") && (GasModel != "AIR-5") && (GasModel != "AIR-7") && (GasModel != "ARGON"))
          ...
          if (SU2_NONEQ_CustomChemistry) cout << "Custom SU2_NONEQ chemistry tables are enabled." << endl;
        }
        break;
      case MAIN_SOLVER::NEMO_NAVIER_STOKES:
        if (Kind_Regime == ENUM_REGIME::COMPRESSIBLE) {
          if (Kind_NEMOTemperatureModel == NEMO_TEMPERATURE_MODEL::SINGLE_TEMPERATURE) cout << "Compressible single-temperature thermochemical non-equilibrium Navier-Stokes equations." << endl;
          else cout << "Compressible two-temperature thermochemical non-equilibrium Navier-Stokes equations." << endl;
        }
        if (Kind_FluidModel == SU2_NONEQ){
          if (!SU2_NONEQ_CustomChemistry && (GasModel != "N2") && (GasModel != "AIR-5") && (GasModel != "AIR-7") && (GasModel != "ARGON"))
          SU2_MPI::Error("The GAS_MODEL given is unavailable using CSU2TCLIB. Choose one of the options: N2, AIR-5, AIR-7, or ARGON.", CURRENT_FUNCTION);
      ...
      case MAIN_SOLVER::NEMO_RANS:
        if (Kind_NEMOTemperatureModel == NEMO_TEMPERATURE_MODEL::SINGLE_TEMPERATURE) cout << "Compressible single-temperature thermochemical non-equilibrium RANS equations." << endl;
        else cout << "Compressible two-temperature thermochemical non-equilibrium RANS equations." << endl;
        if (Kind_FluidModel == SU2_NONEQ){
          if (!SU2_NONEQ_CustomChemistry && (GasModel != "N2") && (GasModel != "AIR-5") && (GasModel != "ARGON"))
      ...
      case MAIN_SOLVER::FEM_LES:
        ...
        break;
      case MAIN_SOLVER::DETONATION_EULER:
        cout << "Detonation Euler equations with operator-split finite-rate chemistry." << endl;
        break;
  ...
  if (val_software == SU2_COMPONENT::SU2_CFD) {
    ...
    if ((Kind_Solver == MAIN_SOLVER::EULER)          || (Kind_Solver == MAIN_SOLVER::NAVIER_STOKES)          || (Kind_Solver == MAIN_SOLVER::RANS) ||
      ...
      if (Kind_ConvNumScheme_Flow == SPACE_UPWIND) {
        ...
        if (Kind_Upwind_Flow == UPWIND::DETONATION_LLF) cout << "Detonation Phase-1 LLF/Rusanov-like placeholder solver for the flow inviscid terms."<< endl;
        if (Kind_Upwind_Flow == UPWIND::DETONATION_HLLC) cout << "Detonation Euler HLLC candidate solver for the flow inviscid terms."<< endl;
        if (Kind_Upwind_Flow == UPWIND::AUSMPLUSM)  cout << "AUSM+M solver for the flow inviscid terms."<< endl;

        if (Kind_Solver == MAIN_SOLVER::EULER         || Kind_Solver == MAIN_SOLVER::DETONATION_EULER || Kind_Solver == MAIN_SOLVER::DISC_ADJ_EULER ||
    ...
    if ((Kind_Solver == MAIN_SOLVER::EULER) || (Kind_Solver == MAIN_SOLVER::NAVIER_STOKES) || (Kind_Solver == MAIN_SOLVER::RANS) ||
      ...
      switch (Kind_TimeIntScheme_Flow) {
        ...
        case POINT_IMPLICIT:
        case EULER_IMPLICIT:
          if (Kind_TimeIntScheme_Flow == POINT_IMPLICIT)
            cout << "Point-implicit method for the flow equations." << endl;
          else
            cout << "Euler implicit method for the flow equations." << endl;
          if (Kind_TimeIntScheme_Flow == POINT_IMPLICIT) {
            cout << "Point-implicit inner block-Jacobi iterations: " << Linear_Solver_Iter << "." << endl;
            cout << "Point-implicit linear tolerance: " << Linear_Solver_Error << "." << endl;
          }
          if (Kind_FluidModel == MUTATIONPP && Kind_NEMOTemperatureModel != NEMO_TEMPERATURE_MODEL::SINGLE_TEMPERATURE)
            SU2_MPI::Error("Implicit/point-implicit time scheme with Mutation++ is currently enabled only for SINGLE_TEMPERATURE mode.", CURRENT_FUNCTION);
...
void CConfig::SetGlobalParam(MAIN_SOLVER val_solver,
  ...
  switch (val_solver) {
    case MAIN_SOLVER::EULER: case MAIN_SOLVER::INC_EULER: case MAIN_SOLVER::DETONATION_EULER: case MAIN_SOLVER::NEMO_EULER:
