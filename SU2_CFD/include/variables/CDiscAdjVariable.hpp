...
public:
   ...
   */
  inline void SetObjectiveTerm(unsigned long iPoint, unsigned long iVar, const su2double solution) final {
    ObjectiveTerm(iPoint,iVar) = solution;
  }
   ...
   * \param[in] solution - Solution of the problem.
   */
  inline su2double GetObjectiveTerm(unsigned long iPoint, unsigned long iVar) final {
    return ObjectiveTerm(iPoint,iVar);
  }
