...
/*!
 * \class CNEMOGas
 * \brief Class for defining the nonequilibrium gas model.
 * \author: C. Garbacz, W. Maier, S. R. Copeland
 */
...
protected:
  ...
  bool single_temperature = false;       /*!< \brief Use single-temperature closure for NEMO. */
...
public:
  ...
  /*!\
   * \brief Return whether the NEMO closure uses a single temperature.
   */
  inline bool GetSingleTemperature(void) const { return single_temperature; }
